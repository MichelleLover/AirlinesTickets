...
class Generator {
    ...
    private val minDate = LocalDate.of(2024, 1, 1).atStartOfDay(zoneID).toEpochSecond()
    private val maxDate = LocalDate.of(2025, 3, 1).atStartOfDay(zoneID).toEpochSecond()
